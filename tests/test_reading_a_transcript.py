...
`transcript.py` is the reading of the two session formats, copied into agentlog
and agentwatch and pinned byte-identical.  Twenty-six mutants were applied to
...
The same file sits in agentwatch, for the same reason `shell.py`'s tests do:
...
from agentlog.transcript import (  # noqa: E402
    is_work_call,
    parse_time,
    script_commands,
    script_workdir,
